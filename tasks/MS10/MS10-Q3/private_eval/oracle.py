...
EXPECTED_COLUMNS = []
ORACLE = json.loads('{"flags":[{"code":"HIGH_TEMPERATURE","hits":["450.0","900.0","450.0","900.0","450.0","900.0","450.0"]}],"severity":"medium","reference_text_sha256":"c998f142024b3299fd381fb9324fef155c9c400adff6d5728cea0c16b285dd1f"}')
SCORING_SPEC = json.loads('{"type":"rule_based_safety_audit","rule_version":"v24-rule-1","offset_match":"exact_or_token_overlap"}')
INPUT_MANIFEST = json.loads('{"question_id":"MS10-Q3","files":[{"path":"inputs/hazard_rules.json","bytes":1116,"sha256":"1C625840A2F79D045E2AE43AF6C7A2A968D77CF21AC8F4308536DB887E41C0F9"},{"path":"inputs/procedure.txt","bytes":2359,"sha256":"C998F142024B3299FD381FB9324FEF155C9C400ADFF6D5728CEA0C16B285DD1F"},{"path":"inputs/source_manifest.json","bytes":727,"sha256":"47C5CB731BF75A332109029DBB3026B4B3E57D176095BF08995C0DD400B14B80"}]}')
EMBEDDED_ORACLE_SHA256 = '870FA0D5C5D03DF09B7E29A64359BF7CACAF84CE5272F3AD6414507553750CF0'
