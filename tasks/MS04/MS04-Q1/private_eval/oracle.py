...
TASK_ID = 'MS04-Q1'
REQUIRED_OUTPUTS = ['distances.csv', 'summary.json', 'report.md', 'analyze.py', 'run_log.jsonl']
MAIN_FILE = 'distances.csv'
EXPECTED_COLUMNS = ['structure', 'wyckoff_rmse', 'wyckoff_mae', 'sinkhorn_dist', 'chamfer_dist', 'hausdorff_dist', 'superpose_rmsd', 'edit_graph_distance', 'fingerPrint', 'XRD_dist', 'OFM_dist', 'status']
ORACLE = json.loads('{"distance_rows":[{"structure":"SrTiO3_pred.cif","energy_distance":"39.9298","wyckoff_rmse":"0.3702","wyckoff_mae":"0.2654","rms_anonymous":"","rms_dist":"None","sinkhorn_dist":"13.2096","chamfer_dist":"4.3629","hausdorff_dist":"3.7809","superpose_rmsd":"1.1436","edit_graph_distance":"6","fingerPrint":"2.5924","XRD_dist":"2.0702","OFM_dist":"0.4755"},{"structure":"GdB2_pred.cif","energy_distance":"4.4822","wyckoff_rmse":"5555","wyckoff_mae":"5555","rms_anonymous":"0.5408","rms_dist":"0.5408","sinkhorn_dist":"5.2826","chamfer_dist":"2.8139","hausdorff_dist":"2.0505","superpose_rmsd":"0.2487","edit_graph_distance":"1","fingerPrint":"2.3997","XRD_dist":"2.1448","OFM_dist":"1.1279"}]}')
SCORING_SPEC = json.loads('{"type":"numeric_table","tolerance_abs":0.0001,"missing_policy":"match_official"}')
INPUT_MANIFEST = json.loads('{"question_id":"MS04-Q1","files":[{"path":"inputs/GdB2_gt.cif","bytes":1185,"sha256":"123725B833CB7697E3C17D3D52472B7F56DA967E2B31AE59019EAAE1742F4C32"},{"path":"inputs/GdB2_pred.cif","bytes":804,"sha256":"A794840CA73F91B794366C4C61758B315909E7D75B7F3D620CB03B554EE6E28D"},{"path":"inputs/source_manifest.json","bytes":700,"sha256":"E0681BA94A29AEE18D2E8E853E2497CDA909AF5129281C88EC1DC1DFDE26AEF0"},{"path":"inputs/SrTiO3_gt.cif","bytes":1013,"sha256":"1537DA657638515E659E3572515B54041EE4E16C3B04033EEAB5150EDA4EC3B8"},{"path":"inputs/SrTiO3_pred.cif","bytes":914,"sha256":"4B1E5D3F272F6EE858EA0963D038547BE531244F80885AB00C7E77FD1427C9D6"}]}')
EMBEDDED_ORACLE_SHA256 = 'E87BCCEFF7DA03EA62584A1C69B22502C09D3F98DF4DE7F59F8110AE3E8E5698'
DERIVED_GOLD = json.loads('{}')
MANUAL_TASKS = set()
MANUAL_ANCHORS = json.loads('{}')
REGRESSION_CONFIG = json.loads('{}')
CRITERIA_LAYOUT = [('官方距离复现', 55), ('状态与覆盖', 10), ('复现', 10), ('报告', 5)]
