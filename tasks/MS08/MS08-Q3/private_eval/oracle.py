...
TASK_ID = 'MS08-Q3'
REQUIRED_OUTPUTS = ['spectral_summary.csv', 'summary.json', 'report.md', 'analyze.py', 'run_log.jsonl', 'dielectric_spectra.png']
MAIN_FILE = 'spectral_summary.csv'
EXPECTED_COLUMNS = ['jid', 'n_points', 'peak_point_id', 'peak_value', 'mean', 'std', 'auc', 'rank']
ORACLE = json.loads('{"rows":[{"jid":"JVASP-266","n_points":200,"peak_point_id":94,"peak_value":22.948,"mean":6.70257},{"jid":"JVASP-1002","n_points":200,"peak_point_id":84,"peak_value":45.348,"mean":8.4898875},{"jid":"JVASP-890","n_points":200,"peak_point_id":86,"peak_value":30.089,"mean":9.6954},{"jid":"JVASP-1174","n_points":200,"peak_point_id":96,"peak_value":25.195999999999984,"mean":7.7333125}]}')
SCORING_SPEC = json.loads('{"type":"spectral_summary","tolerance":1e-08,"plot_required":true}')
INPUT_MANIFEST = json.loads('{"question_id":"MS08-Q3","files":[{"path":"inputs/dielectric_spectra.csv","bytes":18941,"sha256":"22B9345D511480A15A43204405FA7F5946FE7E40092B02532FD6B11D71421E39"},{"path":"inputs/source_manifest.json","bytes":721,"sha256":"DC701642328C2DCE4C34B7E08AD6887D0482043A79E9AAA41830077F1CA33CD4"}]}')
EMBEDDED_ORACLE_SHA256 = 'F7F3CEE2DA6F4471BAAC512F7792EB38EE1EEB25BA018D9F5F5DE7AE59F92456'
DERIVED_GOLD = json.loads('{"rows":[{"jid":"JVASP-1002","n_points":200,"peak_point_id":84,"peak_value":45.348,"mean":8.4898875,"std":10.682450211496132,"auc":1695.02},{"jid":"JVASP-1174","n_points":200,"peak_point_id":96,"peak_value":25.195999999999984,"mean":7.733312499999999,"std":6.216323278964322,"auc":1543.243},{"jid":"JVASP-266","n_points":200,"peak_point_id":94,"peak_value":22.948,"mean":6.70257,"std":4.704532607241658,"auc":1336.992},{"jid":"JVASP-890","n_points":200,"peak_point_id":86,"peak_value":30.089,"mean":9.6954,"std":7.449818901154578,"auc":1934.858}]}')
MANUAL_TASKS = set()
MANUAL_ANCHORS = json.loads('{}')
REGRESSION_CONFIG = json.loads('{}')
CRITERIA_LAYOUT = [('谱统计', 40), ('峰值与排名', 15), ('科研图', 10), ('复现', 10), ('报告', 5)]
