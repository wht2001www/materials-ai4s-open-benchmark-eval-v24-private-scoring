...
EXPECTED_COLUMNS = ['material_id', 'pred_formula_only_ev', 'pred_formula_description_ev']
ORACLE = json.loads('{"test_labels":[{"material_id":"mp-1519998","band_gap":0.0},{"material_id":"mp-1038035","band_gap":1.9765},{"material_id":"mp-1206636","band_gap":0.0},{"material_id":"mp-555398","band_gap":3.4571},{"material_id":"mp-642803","band_gap":0.0},{"material_id":"mp-1042545","band_gap":0.2475},{"material_id":"mp-1197367","band_gap":0.0},{"material_id":"mp-774243","band_gap":1.3642000000000003},{"material_id":"mp-1096189","band_gap":1.0218000000000005},{"material_id":"mp-1639336","band_gap":2.2547}]}')
SCORING_SPEC = json.loads('{"type":"paired_regression","metrics":["mae_a","mae_b","delta_mae"]}')
INPUT_MANIFEST = json.loads('{"question_id":"MS08-Q2","files":[{"path":"inputs/source_manifest.json","bytes":710,"sha256":"2E8089DD0E253A23C84F980AF8EC0FC98B8A2E09CA996E29FBA97D65850B8DF2"},{"path":"inputs/test.csv","bytes":49106,"sha256":"E2AF637F0DC95CC8E92F88E5BBE3FAAD7487B4EC294431503237932DE6955558"},{"path":"inputs/train.csv","bytes":42500,"sha256":"320DDB7DBED50DAECB59BCD7478216E7CB77A7438A91E8EE26935D1C044AACD3"}]}')
EMBEDDED_ORACLE_SHA256 = '973B955C2E2770C9FAF73C62C76735357C84B0D34B8073E691A293B56FC467AE'
DERIVED_GOLD = json.loads('{}')
MANUAL_TASKS = set()
MANUAL_ANCHORS = json.loads('{}')
REGRESSION_CONFIG = json.loads('{}')
CRITERIA_LAYOUT = [('B 模型隐藏 MAE', 25), ('A 模型隐藏 MAE', 15), ('A/B 差异与覆盖', 10), ('消融协议', 15), ('复现', 10), ('报告', 5)]
