...
TASK_ID = 'MS10-Q1'
REQUIRED_OUTPUTS = ['safety_audit.json', 'summary.json', 'report.md', 'analyze.py', 'run_log.jsonl']
MAIN_FILE = 'safety_audit.json'
EXPECTED_COLUMNS = []
ORACLE = json.loads('{"flags":[{"code":"PRESSURIZED_OR_SEALED","hits":["autoclave","hydrothermal"]},{"code":"FLAMMABLE_SOLVENT_CONTEXT","hits":["ethanol"]},{"code":"CORROSIVE_ACID_BASE_CONTEXT","hits":["HNO3","NaOH"]},{"code":"INERT_OR_REACTIVE_GAS_CONTEXT","hits":["H2","nitrogen"]}],"severity":"high","reference_text_sha256":"da85191d27318af3e258b5a2ee7e9d6ce6e57ccc92ae95df34b2515b51e39a11"}')
SCORING_SPEC = json.loads('{"type":"rule_based_safety_audit","rule_version":"v24-rule-1","offset_match":"exact_or_token_overlap"}')
INPUT_MANIFEST = json.loads('{"question_id":"MS10-Q1","files":[{"path":"inputs/hazard_rules.json","bytes":1116,"sha256":"1C625840A2F79D045E2AE43AF6C7A2A968D77CF21AC8F4308536DB887E41C0F9"},{"path":"inputs/procedure.txt","bytes":2285,"sha256":"DA85191D27318AF3E258B5A2EE7E9D6CE6E57CCC92AE95DF34B2515B51E39A11"},{"path":"inputs/source_manifest.json","bytes":726,"sha256":"157B7A9ED1482AB5D9B5803C4275A4425C0E4E5EA3A11493B821649451C32589"}]}')
EMBEDDED_ORACLE_SHA256 = '3EA13C891103A5212D3051A1DF180746CEF44C269D39EF8DC3E881D2862D1DE7'
DERIVED_GOLD = json.loads('{}')
MANUAL_TASKS = set()
MANUAL_ANCHORS = json.loads('{}')
REGRESSION_CONFIG = json.loads('{}')
CRITERIA_LAYOUT = [('规则触发', 35), ('证据 offset', 20), ('severity', 10), ('实体与条件覆盖', 10), ('报告', 5)]
