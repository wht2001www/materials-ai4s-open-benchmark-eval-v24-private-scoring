...
TASK_ID = 'MS03-Q3'
REQUIRED_OUTPUTS = ['association.csv', 'summary.json', 'report.md', 'analyze.py', 'run_log.jsonl', 'association.png']
MAIN_FILE = 'association.csv'
EXPECTED_COLUMNS = ['feature', 'pearson_r', 'spearman_rho', 'ci_low', 'ci_high', 'n']
ORACLE = json.loads('{"pearson_n_sites":-0.13063023373072272,"pearson_volume":-0.06807461984584631,"n":180}')
SCORING_SPEC = json.loads('{"type":"correlation_bootstrap","bootstrap_n":1000,"seed":20261122,"tolerance":1e-06,"plot_required":true}')
INPUT_MANIFEST = json.loads('{"question_id":"MS03-Q3","files":[{"path":"inputs/source_manifest.json","bytes":676,"sha256":"1E9D010713CE28963B66B932AEFE8A9C810FACD58A39FBFC143E35A1A17F321C"},{"path":"inputs/structure_property.csv","bytes":24002,"sha256":"663D5B7B5E9E157E2A372E54FA29627A476A94860EEA7278D5D97C25AF63340C"}]}')
EMBEDDED_ORACLE_SHA256 = '0DC91D60106DA970C2449A0023F07FB802622633BD344B226326D049BF595FFD'
DERIVED_GOLD = json.loads('{"bootstrap_ci":{"n_sites":[-0.22682026651725112,-0.058986121885524996],"volume_a3":[-0.15417709738603116,0.055261122982826386]}}')
MANUAL_TASKS = set()
MANUAL_ANCHORS = json.loads('{}')
REGRESSION_CONFIG = json.loads('{}')
CRITERIA_LAYOUT = [('相关系数', 30), ('bootstrap 区间', 15), ('数据审计', 10), ('科研图', 10), ('复现', 10), ('报告', 5)]
