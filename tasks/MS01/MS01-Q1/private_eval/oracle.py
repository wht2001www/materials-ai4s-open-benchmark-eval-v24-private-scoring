...
TASK_ID = 'MS01-Q1'
REQUIRED_OUTPUTS = ['screening.csv', 'summary.json', 'report.md', 'analyze.py', 'run_log.jsonl']
MAIN_FILE = 'screening.csv'
EXPECTED_COLUMNS = ['material_id', 'formula', 'eligible', 'exclusion_reasons', 'rank']
ORACLE = json.loads('{"eligible_ids":["mp-863658","mp-862986","mp-862867","mp-1186534","mp-1102233","mp-1008394","mp-103","mp-104","mp-10658","mp-11","mp-113","mp-11534","mp-11698","mp-1184115","mp-131","mp-145","mp-155","mp-19","mp-26","mp-38","mp-49","mp-571261","mp-67","mp-69","mp-862690","mp-867200","mp-87","mp-90","mp-1018122","mp-567313","mp-1096840","mp-1179962","mp-22848","mp-973571","mp-23157","mp-86","mp-1186440","mp-867351","mp-143","mp-981544","mp-1184067","mp-1184367","mp-1186535","mp-989695","mp-99","mp-14","mp-989782","mp-1184113","mp-613989","mp-567630","mp-1182070","mp-1059528","mp-21462","mp-971769","mp-567379","mp-1179917","mp-571249","mp-1057315","mp-1183057","mp-1077723","mp-56","mp-88","mp-863657","mp-1058581","mp-18","mp-570087","mp-68","mp-158","mp-1104341","mp-10257","mp-639727","mp-1186367","mp-1059256","mp-147","mp-19981","mp-1009594","mp-570778","mp-11832","mp-1067758","mp-1183897","mp-1186916","mp-1182809","mp-1183241","mp-570459","mp-1186658","mp-1183069","mp-1009460","mp-1186558","mp-1012110","mp-949029","mp-105","mp-1183230","mp-1178952","mp-1183109","mp-1096851"],"top20":["mp-863658","mp-862986","mp-862867","mp-1186534","mp-1102233","mp-1008394","mp-103","mp-104","mp-10658","mp-11","mp-113","mp-11534","mp-11698","mp-1184115","mp-131","mp-145","mp-155","mp-19","mp-26","mp-38"]}')
SCORING_SPEC = json.loads('{"type":"exact_screen_and_rank","tolerance":0.0}')
INPUT_MANIFEST = json.loads('{"question_id":"MS01-Q1","files":[{"path":"inputs/candidates.csv","bytes":13010,"sha256":"BD7E71D567BA27AC10028ABEA46C6A719CBCD8146FAC313818AB6EAA26ECE3E6"},{"path":"inputs/constraints.json","bytes":278,"sha256":"15FC9EB4FD300DD6FE070B27451F0744171FB5B1D107A4C0FC02042423683F33"},{"path":"inputs/source_manifest.json","bytes":665,"sha256":"165C6FB837E51602C3F6C39191EED0DDC0217D5CDDD3844BD183A6A468D002C3"}]}')
EMBEDDED_ORACLE_SHA256 = '4F89F58203206DF294AB335982F9734DCEDF3319A7A9A88D4D20C5F4A131AD69'
DERIVED_GOLD = json.loads('{}')
MANUAL_TASKS = set()
MANUAL_ANCHORS = json.loads('{}')
REGRESSION_CONFIG = json.loads('{}')
CRITERIA_LAYOUT = [('硬约束判定', 40), ('Top-k 排序', 20), ('格式与覆盖', 10), ('复现', 5), ('报告', 5)]
