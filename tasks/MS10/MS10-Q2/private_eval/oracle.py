...
EXPECTED_COLUMNS = []
ORACLE = json.loads('{"flags":[{"code":"FLAMMABLE_SOLVENT_CONTEXT","hits":["ethanol"]},{"code":"CORROSIVE_ACID_BASE_CONTEXT","hits":["HCl","HNO3"]},{"code":"TOXIC_METAL_CONTEXT","hits":["Hg"]},{"code":"INERT_OR_REACTIVE_GAS_CONTEXT","hits":["hydrogen"]}],"severity":"high","reference_text_sha256":"15306e0c80c33a52ed4da0642ebd682e518f4ed0a3bff6f0e53a1b19d71dcc11"}')
SCORING_SPEC = json.loads('{"type":"rule_based_safety_audit","rule_version":"v24-rule-1","offset_match":"exact_or_token_overlap"}')
INPUT_MANIFEST = json.loads('{"question_id":"MS10-Q2","files":[{"path":"inputs/hazard_rules.json","bytes":1116,"sha256":"1C625840A2F79D045E2AE43AF6C7A2A968D77CF21AC8F4308536DB887E41C0F9"},{"path":"inputs/procedure.txt","bytes":2501,"sha256":"15306E0C80C33A52ED4DA0642EBD682E518F4ED0A3BFF6F0E53A1B19D71DCC11"},{"path":"inputs/source_manifest.json","bytes":770,"sha256":"417EE8D140CB27872FA2BA393A339574D1120F6C7C22B327316CD6347F407A74"}]}')
EMBEDDED_ORACLE_SHA256 = 'D49C0F56C8C36E629B487A1750CACEFDB5DF6B34A2023737FA60481001D33E69'
